...
#Definir une fonction comprenant les règles de supériorité du pierre feuille ciseau ayant pour paramètre le choix du joueur et le choix de l'ordi
...
#Definir une fonction permettant de lancer la partie de pierre feuille ciseau avec en paramètre le choix du joueur
...
#Tans que rejouer n'est pas égal à "non":
    #Selection d'un élèment aléatoire dans le tableau
